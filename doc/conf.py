...
latex_documents = [
  ('index', 'SimpleCV.tex', 'SimpleCV Documentation',
   'Ingeuitas', 'manual'),
]
...
man_pages = [
    ('index', 'simplecv', 'SimpleCV Documentation',
     ['Ingeuitas'], 1)
]
...
texinfo_documents = [
  ('index', 'SimpleCV', 'SimpleCV Documentation', 'Ingeuitas',
...
epub_title = 'SimpleCV'
epub_author = 'Ingeuitas'
epub_publisher = 'Ingeuitas'
epub_copyright = '2011, Ingeuitas'
